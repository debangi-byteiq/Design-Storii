...
def create_product_list(page):
    ...
    scroll_page(page, 'div.footer__copyright', 4)
...
def find_metal_details(desc):
    ...
    try:
        # details['MetailPurity'] = int(re.search(r'(\d+)kt', metal, re.IGNORECASE).group(1))
...
def main():
    ...
    with sync_playwright() as p:
        ...
        # print(scrape_product('https://manubhai.in/new_product_detail.php?product_id=1077', page, company_name, country_name, run_date, 1))
        # exit()
