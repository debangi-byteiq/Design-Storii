...
def main():
    ...
    with sync_playwright() as p:
        ...
        # print(scrape_product('https://reliancejewels.com/14-karat-gold-diamond-bracelet/all-jewellery/bangles-bracelet/product:538552/cid:168/?pos=1', page, company_name, country_name, run_date, 1))
        # exit()
