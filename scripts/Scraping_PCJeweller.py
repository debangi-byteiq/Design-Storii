...
from utils.functions import clear_popup,remove_non_numeric_chars,  ping_my_db, find_row_using_existing, get_category, find_metal_colour,find_gold_purity,  open_new_page, save_image_to_s3, update_flag_to_delete, save_to_excel, scroll_page
